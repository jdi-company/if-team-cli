...
Examples:
  ...
  if-team iteration delete 345 --yes                # delete without prompt`,
    ...
    iteration
        ...
        .option('--amount <number>', 'Amount (required by the API when to_project_amount is true; defaults to 0)')
        .option('--exchange-rate <number>', 'Exchange rate')
        .option('--to-project-amount', 'Set to_project_amount = true (defaults to false when omitted)')
